...
import { THR_CABANG_FIELDS } from "@/lib/thr-cabang-fields";
...
export default function THRCabangReportPage() {
    ...
    try {
      const response = await fetch("/api/reports", {
        ...
        body: JSON.stringify({
          ...
          reportType: "THR_CABANG",
          selectedFields: THR_CABANG_FIELDS,
        }),
      });
      ...
      if (response.ok) {
        showToast(
          "success",
          `THR Cabang report "${reportName}" created successfully!`
        );
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              THR estimation for branch employees (COA 500) -{" "}
              {THR_CABANG_FIELDS.length} fields
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., THR Cabang Oktober 2025"
          ...
          <button
            ...
            className="w-full px-6 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center text-lg font-semibold"
          >
            {generating ? (
              <>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 rounded-lg p-4">
                ...
                <div className="space-y-2 text-xs text-green-700">
                  ...
                  <div className="bg-white px-2 py-1 rounded">
                    • Sheet 2: Detail ({THR_CABANG_FIELDS.length} fields)
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-50 rounded-lg p-4">
                ...
                <p className="text-xs text-amber-700">
                  Only COA 500 (Branch employees, excluding Kantor Pusat)
                </p>
              </div>
